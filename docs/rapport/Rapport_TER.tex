...
\begin{document}
	...
	Le \emph{Test-Time Training} (TTT), introduit par Sun et al.~\cite{sun2020ttt}, propose une réponse à cette problématique en permettant au modèle de continuer à apprendre pendant l’inférence grâce à une tâche auto-supervisée auxiliaire.
